...
export function HeroSection() {
  return (
    <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-yellow-darkest/90 via-yellow-darkest/80 to-yellow-darkest/90" />
      </div>
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-yellow-light mb-4 md:mb-6"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Vítej na <span className="text-primary drop-shadow-lg">Mandem Military</span>
          </motion.h1>

          <motion.p
            className="text-lg sm:text-xl md:text-2xl text-yellow-light/90 mb-6 md:mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-md"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            Zažij nejlepší vojenský roleplay zážitek v České republice. Připoj se k naší komunitě a začni svou cestu.
          </motion.p>
